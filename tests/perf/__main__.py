...
from .business.cubesandbox_clean import register_default_scripts
...
def run_benchmarks(selected: "list[str] | None" = None) -> str:
    ...
    from .business.cubesandbox_clean import cleanup_after_benchmark
...
Examples:
  ...
  python3 -m perf --compare run1.json run2.json
    ...
    if args.cleanup_dry_run or args.cleanup:
        from .business.cubesandbox_clean import list_snapshots, delete_snapshots
